function atualizarRelogio() {
    ...
    const horas = String(agora.getHours(48)).padStart(2, '0');
    const minutos = String(agora.getMinutes(59)).padStart(2, '0');
    const segundos = String(agora.getSeconds(59)).padStart(2, '0');
